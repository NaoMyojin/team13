...
<img src="screen/game.png" alt="スクリーンショット" width="500">
...
<img src="screen/game_finish.png" alt="スクリーンショット" width="500">

「ホームに戻る」ボタンをクリックして、ホーム画面に戻ってください。
* ステージをクリアするとライフが1つ回復します。

# マニュアル画面について
* ホーム画面の「マニュアル」ボタンをクリックすることで表示されます。
* マニュアルの内容が理解できたら、「ホームに戻る」ボタンをクリックすると、ホーム画面に戻ります。

<img src="screen/manual.png" alt="スクリーンショット" width="500">

# ランキング画面について
* ホーム画面の「ランキング」ボタンをクリックすることで表示されます。
* スコア（クリアしたステージ数）が表示されます。
* 「ホームに戻る」ボタンをクリックすると、ホーム画面に戻ります。

<img src="screen/ranking.png" alt="スクリーンショット" width="500">
